 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hp;function wv(){if(Hp)return Do;Hp=1;var s=ed(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,a=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function c(d,p,m){var _,x={},v=null,S=null;m!==void 0&&(v=""+m),p.key!==void 0&&(v=""+p.key),p.ref!==void 0&&(S=p.ref);for(_ in p)r.call(p,_)&&!u.hasOwnProperty(_)&&(x[_]=p[_]);if(d&&d.defaultProps)for(_ in p=d.defaultProps,p)x[_]===void 0&&(x[_]=p[_]);return{$$typeof:e,type:d,key:v,ref:S,props:x,_owner:a.current}}return Do.Fragment=t,Do.jsx=c,Do.jsxs=c,Do}var Gp;function Av(){return Gp||(Gp=1,Ec.exports=wv()),Ec.exports}var qn=Av(),ai=ed(),Ja={},Tc={exports:{}},An={},wc={exports:{}},Ac={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Wp;function Rv(){return Wp||(Wp=1,(function(s){function e(B,ae){var re=B.length;B.push(ae);e:for(;0<re;){var N=re-1>>>1,ne=B[N];if(0<a(ne,ae))B[N]=ae,B[re]=ne,re=N;else break e}}function t(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var ae=B[0],re=B.pop();if(re!==ae){B[0]=re;e:for(var N=0,ne=B.length,De=ne>>>1;N<De;){var K=2*(N+1)-1,ue=B[K],Ee=K+1,ve=B[Ee];if(0>a(ue,re))Ee<ne&&0>a(ve,ue)?(B[N]=ve,B[Ee]=re,N=Ee):(B[N]=ue,B[K]=re,N=K);else if(Ee<ne&&0>a(ve,re))B[N]=ve,B[Ee]=re,N=Ee;else break e}}return ae}function a(B,ae){var re=B.sortIndex-ae.sortIndex;return re!==0?re:B.id-ae.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var c=Date,d=c.now();s.unstable_now=function(){return c.now()-d}}var p=[],m=[],_=1,x=null,v=3,S=!1,A=!1,C=!1,y=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(B){for(var ae=t(m);ae!==null;){if(ae.callback===null)r(m);else if(ae.startTime<=B)r(m),ae.sortIndex=ae.expirationTime,e(p,ae);else break;ae=t(m)}}function R(B){if(C=!1,b(B),!A)if(t(p)!==null)A=!0,oe(Y);else{var ae=t(m);ae!==null&&le(R,ae.startTime-B)}}function Y(B,ae){A=!1,C&&(C=!1,g(V),V=-1),S=!0;var re=v;try{for(b(ae),x=t(p);x!==null&&(!(x.expirationTime>ae)||B&&!k());){var N=x.callback;if(typeof N=="function"){x.callback=null,v=x.priorityLevel;var ne=N(x.expirationTime<=ae);ae=s.unstable_now(),typeof ne=="function"?x.callback=ne:x===t(p)&&r(p),b(ae)}else r(p);x=t(p)}if(x!==null)var De=!0;else{var K=t(m);K!==null&&le(R,K.startTime-ae),De=!1}return De}finally{x=null,v=re,S=!1}}var O=!1,I=null,V=-1,P=5,T=-1;function k(){return!(s.unstable_now()-T<P)}function se(){if(I!==null){var B=s.unstable_now();T=B;var ae=!0;try{ae=I(!0,B)}finally{ae?te():(O=!1,I=null)}}else O=!1}var te;if(typeof L=="function")te=function(){L(se)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,he=fe.port2;fe.port1.onmessage=se,te=function(){he.postMessage(null)}}else te=function(){y(se,0)};function oe(B){I=B,O||(O=!0,te())}function le(B,ae){V=y(function(){B(s.unstable_now())},ae)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(B){B.callback=null},s.unstable_continueExecution=function(){A||S||(A=!0,oe(Y))},s.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<B?Math.floor(1e3/B):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_getFirstCallbackNode=function(){return t(p)},s.unstable_next=function(B){switch(v){case 1:case 2:case 3:var ae=3;break;default:ae=v}var re=v;v=ae;try{return B()}finally{v=re}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(B,ae){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var re=v;v=B;try{return ae()}finally{v=re}},s.unstable_scheduleCallback=function(B,ae,re){var N=s.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?N+re:N):re=N,B){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=re+ne,B={id:_++,callback:ae,priorityLevel:B,startTime:re,expirationTime:ne,sortIndex:-1},re>N?(B.sortIndex=re,e(m,B),t(p)===null&&B===t(m)&&(C?(g(V),V=-1):C=!0,le(R,re-N))):(B.sortIndex=ne,e(p,B),A||S||(A=!0,oe(Y))),B},s.unstable_shouldYield=k,s.unstable_wrapCallback=function(B){var ae=v;return function(){var re=v;v=ae;try{return B.apply(this,arguments)}finally{v=re}}}})(Ac)),Ac}var Xp;function Cv(){return Xp||(Xp=1,wc.exports=Rv()),wc.exports}/**
 * @license React
...
`)+`
`+g);const b=L+y+c,R=L+g+d,Y=Fm(a,a.VERTEX_SHADER,b),O=Fm(a,a.FRAGMENT_SHADER,R);a.attachShader(C,Y),a.attachShader(C,O),t.index0AttributeName!==void 0?a.bindAttribLocation(C,0,t.index0AttributeName):t.morphTargets===!0&&a.bindAttribLocation(C,0,"position"),a.linkProgram(C);function I(k){if(s.debug.checkShaderErrors){const se=a.getProgramInfoLog(C).trim(),te=a.getShaderInfoLog(Y).trim(),fe=a.getShaderInfoLog(O).trim();let he=!0,oe=!0;if(a.getProgramParameter(C,a.LINK_STATUS)===!1)if(he=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,C,Y,O);else{const le=km(a,Y,"vertex"),B=km(a,O,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(C,a.VALIDATE_STATUS)+`
...
}`;class bM{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,r){if(this.texture===null){const a=new bn,u=e.properties.get(a);u.__webglTexture=t.texture,(t.depthNear!=r.depthNear||t.depthFar!=r.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=a}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,r=new ji({vertexShader:CM,fragmentShader:PM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new yi(new zl(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class LM extends Zs{constructor(e,t){super();const r=this;let a=null,u=1,c=null,d="local-floor",p=1,m=null,_=null,x=null,v=null,S=null,A=null;const C=new bM,y=t.getContextAttributes();let g=null,L=null;const b=[],R=[],Y=new St;let O=null;const I=new jn;I.viewport=new Bt;const V=new jn;V.viewport=new Bt;const P=[I,V],T=new AM;let k=null,se=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let ue=b[K];return ue===void 0&&(ue=new nf,b[K]=ue),ue.getTargetRaySpace()},this.getControllerGrip=function(K){let ue=b[K];return ue===void 0&&(ue=new nf,b[K]=ue),ue.getGripSpace()},this.getHand=function(K){let ue=b[K];return ue===void 0&&(ue=new nf,b[K]=ue),ue.getHandSpace()};function te(K){const ue=R.indexOf(K.inputSource);if(ue===-1)return;const Ee=b[ue];Ee!==void 0&&(Ee.update(K.inputSource,K.frame,m||c),Ee.dispatchEvent({type:K.type,data:K.inputSource}))}function fe(){a.removeEventListener("select",te),a.removeEventListener("selectstart",te),a.removeEventListener("selectend",te),a.removeEventListener("squeeze",te),a.removeEventListener("squeezestart",te),a.removeEventListener("squeezeend",te),a.removeEventListener("end",fe),a.removeEventListener("inputsourceschange",he);for(let K=0;K<b.length;K++){const ue=R[K];ue!==null&&(R[K]=null,b[K].disconnect(ue))}k=null,se=null,C.reset(),e.setRenderTarget(g),S=null,v=null,x=null,a=null,L=null,De.stop(),r.isPresenting=!1,e.setPixelRatio(O),e.setSize(Y.width,Y.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){u=K,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){d=K,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||c},this.setReferenceSpace=function(K){m=K},this.getBaseLayer=function(){return v!==null?v:S},this.getBinding=function(){return x},this.getFrame=function(){return A},this.getSession=function(){return a},this.setSession=async function(K){if(a=K,a!==null){if(g=e.getRenderTarget(),a.addEventListener("select",te),a.addEventListener("selectstart",te),a.addEventListener("selectend",te),a.addEventListener("squeeze",te),a.addEventListener("squeezestart",te),a.addEventListener("squeezeend",te),a.addEventListener("end",fe),a.addEventListener("inputsourceschange",he),y.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(Y),a.renderState.layers===void 0){const ue={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:u};S=new XRWebGLLayer(a,t,ue),a.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),L=new ts(S.framebufferWidth,S.framebufferHeight,{format:ci,type:qi,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil})}else{let ue=null,Ee=null,ve=null;y.depth&&(ve=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ue=y.stencil?js:Hs,Ee=y.stencil?Ys:es);const we={colorFormat:t.RGBA8,depthFormat:ve,scaleFactor:u};x=new XRWebGLBinding(a,t),v=x.createProjectionLayer(we),a.updateRenderState({layers:[v]}),e.setPixelRatio(1),e.setSize(v.textureWidth,v.textureHeight,!1),L=new ts(v.textureWidth,v.textureHeight,{format:ci,type:qi,depthTexture:new Rg(v.textureWidth,v.textureHeight,Ee,void 0,void 0,void 0,void 0,void 0,void 0,ue),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(p),m=null,c=await a.requestReferenceSpace(d),De.setContext(a),De.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode},this.getDepthTexture=function(){return C.getDepthTexture()};function he(K){for(let ue=0;ue<K.removed.length;ue++){const Ee=K.removed[ue],ve=R.indexOf(Ee);ve>=0&&(R[ve]=null,b[ve].disconnect(Ee))}for(let ue=0;ue<K.added.length;ue++){const Ee=K.added[ue];let ve=R.indexOf(Ee);if(ve===-1){for(let Ue=0;Ue<b.length;Ue++)if(Ue>=R.length){R.push(Ee),ve=Ue;break}else if(R[Ue]===null){R[Ue]=Ee,ve=Ue;break}if(ve===-1)break}const we=b[ve];we&&we.connect(Ee)}}const oe=new Z,le=new Z;function B(K,ue,Ee){oe.setFromMatrixPosition(ue.matrixWorld),le.setFromMatrixPosition(Ee.matrixWorld);const ve=oe.distanceTo(le),we=ue.projectionMatrix.elements,Ue=Ee.projectionMatrix.elements,Ke=we[14]/(we[10]-1),Rt=we[14]/(we[10]+1),dt=(we[9]+1)/we[5],bt=(we[9]-1)/we[5],X=(we[8]-1)/we[0],hn=(Ue[8]+1)/Ue[0],ft=Ke*X,lt=Ke*hn,Ye=ve/(-X+hn),Tt=Ye*-X;if(ue.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(Tt),K.translateZ(Ye),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),we[10]===-1)K.projectionMatrix.copy(ue.projectionMatrix),K.projectionMatrixInverse.copy(ue.projectionMatrixInverse);else{const qe=Ke+Ye,D=Rt+Ye,M=ft-Tt,$=lt+(ve-Tt),pe=dt*Rt/D*qe,ge=bt*Rt/D*qe;K.projectionMatrix.makePerspective(M,$,pe,ge,qe,D),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ae(K,ue){ue===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(ue.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(a===null)return;let ue=K.near,Ee=K.far;C.texture!==null&&(C.depthNear>0&&(ue=C.depthNear),C.depthFar>0&&(Ee=C.depthFar)),T.near=V.near=I.near=ue,T.far=V.far=I.far=Ee,(k!==T.near||se!==T.far)&&(a.updateRenderState({depthNear:T.near,depthFar:T.far}),k=T.near,se=T.far),I.layers.mask=K.layers.mask|2,V.layers.mask=K.layers.mask|4,T.layers.mask=I.layers.mask|V.layers.mask;const ve=K.parent,we=T.cameras;ae(T,ve);for(let Ue=0;Ue<we.length;Ue++)ae(we[Ue],ve);we.length===2?B(T,I,V):T.projectionMatrix.copy(I.projectionMatrix),re(K,T,ve)};function re(K,ue,Ee){Ee===null?K.matrix.copy(ue.matrixWorld):(K.matrix.copy(Ee.matrixWorld),K.matrix.invert(),K.matrix.multiply(ue.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(ue.projectionMatrix),K.projectionMatrixInverse.copy(ue.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Yf*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return T},this.getFoveation=function(){if(!(v===null&&S===null))return p},this.setFoveation=function(K){p=K,v!==null&&(v.fixedFoveation=K),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=K)},this.hasDepthSensing=function(){return C.texture!==null},this.getDepthSensingMesh=function(){return C.getMesh(T)};let N=null;function ne(K,ue){if(_=ue.getViewerPose(m||c),A=ue,_!==null){const Ee=_.views;S!==null&&(e.setRenderTargetFramebuffer(L,S.framebuffer),e.setRenderTarget(L));let ve=!1;Ee.length!==T.cameras.length&&(T.cameras.length=0,ve=!0);for(let Ue=0;Ue<Ee.length;Ue++){const Ke=Ee[Ue];let Rt=null;if(S!==null)Rt=S.getViewport(Ke);else{const bt=x.getViewSubImage(v,Ke);Rt=bt.viewport,Ue===0&&(e.setRenderTargetTextures(L,bt.colorTexture,v.ignoreDepthValues?void 0:bt.depthStencilTexture),e.setRenderTarget(L))}let dt=P[Ue];dt===void 0&&(dt=new jn,dt.layers.enable(Ue),dt.viewport=new Bt,P[Ue]=dt),dt.matrix.fromArray(Ke.transform.matrix),dt.matrix.decompose(dt.position,dt.quaternion,dt.scale),dt.projectionMatrix.fromArray(Ke.projectionMatrix),dt.projectionMatrixInverse.copy(dt.projectionMatrix).invert(),dt.viewport.set(Rt.x,Rt.y,Rt.width,Rt.height),Ue===0&&(T.matrix.copy(dt.matrix),T.matrix.decompose(T.position,T.quaternion,T.scale)),ve===!0&&T.cameras.push(dt)}const we=a.enabledFeatures;if(we&&we.includes("depth-sensing")){const Ue=x.getDepthInformation(Ee[0]);Ue&&Ue.isValid&&Ue.texture&&C.init(e,Ue,a.renderState)}}for(let Ee=0;Ee<b.length;Ee++){const ve=R[Ee],we=b[Ee];ve!==null&&we!==void 0&&we.update(ve,ue,m||c)}N&&N(K,ue),ue.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ue}),A=null}const De=new wg;De.setAnimationLoop(ne),this.setAnimationLoop=function(K){N=K},this.dispose=function(){}}}const Yr=new Yi,DM=new zt;function UM(s,e){function t(y,g){y.matrixAutoUpdate===!0&&y.updateMatrix(),g.value.copy(y.matrix)}function r(y,g){g.color.getRGB(y.fogColor.value,Eg(s)),g.isFog?(y.fogNear.value=g.near,y.fogFar.value=g.far):g.isFogExp2&&(y.fogDensity.value=g.density)}function a(y,g,L,b,R){g.isMeshBasicMaterial||g.isMeshLambertMaterial?u(y,g):g.isMeshToonMaterial?(u(y,g),x(y,g)):g.isMeshPhongMaterial?(u(y,g),_(y,g)):g.isMeshStandardMaterial?(u(y,g),v(y,g),g.isMeshPhysicalMaterial&&S(y,g,R)):g.isMeshMatcapMaterial?(u(y,g),A(y,g)):g.isMeshDepthMaterial?u(y,g):g.isMeshDistanceMaterial?(u(y,g),C(y,g)):g.isMeshNormalMaterial?u(y,g):g.isLineBasicMaterial?(c(y,g),g.isLineDashedMaterial&&d(y,g)):g.isPointsMaterial?p(y,g,L,b):g.isSpriteMaterial?m(y,g):g.isShadowMaterial?(y.color.value.copy(g.color),y.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function u(y,g){y.opacity.value=g.opacity,g.color&&y.diffuse.value.copy(g.color),g.emissive&&y.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(y.map.value=g.map,t(g.map,y.mapTransform)),g.alphaMap&&(y.alphaMap.value=g.alphaMap,t(g.alphaMap,y.alphaMapTransform)),g.bumpMap&&(y.bumpMap.value=g.bumpMap,t(g.bumpMap,y.bumpMapTransform),y.bumpScale.value=g.bumpScale,g.side===Pn&&(y.bumpScale.value*=-1)),g.normalMap&&(y.normalMap.value=g.normalMap,t(g.normalMap,y.normalMapTransform),y.normalScale.value.copy(g.normalScale),g.side===Pn&&y.normalScale.value.negate()),g.displacementMap&&(y.displacementMap.value=g.displacementMap,t(g.displacementMap,y.displacementMapTransform),y.displacementScale.value=g.displacementScale,y.displacementBias.value=g.displacementBias),g.emissiveMap&&(y.emissiveMap.value=g.emissiveMap,t(g.emissiveMap,y.emissiveMapTransform)),g.specularMap&&(y.specularMap.value=g.specularMap,t(g.specularMap,y.specularMapTransform)),g.alphaTest>0&&(y.alphaTest.value=g.alphaTest);const L=e.get(g),b=L.envMap,R=L.envMapRotation;b&&(y.envMap.value=b,Yr.copy(R),Yr.x*=-1,Yr.y*=-1,Yr.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Yr.y*=-1,Yr.z*=-1),y.envMapRotation.value.setFromMatrix4(DM.makeRotationFromEuler(Yr)),y.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,y.reflectivity.value=g.reflectivity,y.ior.value=g.ior,y.refractionRatio.value=g.refractionRatio),g.lightMap&&(y.lightMap.value=g.lightMap,y.lightMapIntensity.value=g.lightMapIntensity,t(g.lightMap,y.lightMapTransform)),g.aoMap&&(y.aoMap.value=g.aoMap,y.aoMapIntensity.value=g.aoMapIntensity,t(g.aoMap,y.aoMapTransform))}function c(y,g){y.diffuse.value.copy(g.color),y.opacity.value=g.opacity,g.map&&(y.map.value=g.map,t(g.map,y.mapTransform))}function d(y,g){y.dashSize.value=g.dashSize,y.totalSize.value=g.dashSize+g.gapSize,y.scale.value=g.scale}function p(y,g,L,b){y.diffuse.value.copy(g.color),y.opacity.value=g.opacity,y.size.value=g.size*L,y.scale.value=b*.5,g.map&&(y.map.value=g.map,t(g.map,y.uvTransform)),g.alphaMap&&(y.alphaMap.value=g.alphaMap,t(g.alphaMap,y.alphaMapTransform)),g.alphaTest>0&&(y.alphaTest.value=g.alphaTest)}function m(y,g){y.diffuse.value.copy(g.color),y.opacity.value=g.opacity,y.rotation.value=g.rotation,g.map&&(y.map.value=g.map,t(g.map,y.mapTransform)),g.alphaMap&&(y.alphaMap.value=g.alphaMap,t(g.alphaMap,y.alphaMapTransform)),g.alphaTest>0&&(y.alphaTest.value=g.alphaTest)}function _(y,g){y.specular.value.copy(g.specular),y.shininess.value=Math.max(g.shininess,1e-4)}function x(y,g){g.gradientMap&&(y.gradientMap.value=g.gradientMap)}function v(y,g){y.metalness.value=g.metalness,g.metalnessMap&&(y.metalnessMap.value=g.metalnessMap,t(g.metalnessMap,y.metalnessMapTransform)),y.roughness.value=g.roughness,g.roughnessMap&&(y.roughnessMap.value=g.roughnessMap,t(g.roughnessMap,y.roughnessMapTransform)),g.envMap&&(y.envMapIntensity.value=g.envMapIntensity)}function S(y,g,L){y.ior.value=g.ior,g.sheen>0&&(y.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),y.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(y.sheenColorMap.value=g.sheenColorMap,t(g.sheenColorMap,y.sheenColorMapTransform)),g.sheenRoughnessMap&&(y.sheenRoughnessMap.value=g.sheenRoughnessMap,t(g.sheenRoughnessMap,y.sheenRoughnessMapTransform))),g.clearcoat>0&&(y.clearcoat.value=g.clearcoat,y.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(y.clearcoatMap.value=g.clearcoatMap,t(g.clearcoatMap,y.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(y.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,t(g.clearcoatRoughnessMap,y.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(y.clearcoatNormalMap.value=g.clearcoatNormalMap,t(g.clearcoatNormalMap,y.clearcoatNormalMapTransform),y.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===Pn&&y.clearcoatNormalScale.value.negate())),g.dispersion>0&&(y.dispersion.value=g.dispersion),g.iridescence>0&&(y.iridescence.value=g.iridescence,y.iridescenceIOR.value=g.iridescenceIOR,y.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],y.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(y.iridescenceMap.value=g.iridescenceMap,t(g.iridescenceMap,y.iridescenceMapTransform)),g.iridescenceThicknessMap&&(y.iridescenceThicknessMap.value=g.iridescenceThicknessMap,t(g.iridescenceThicknessMap,y.iridescenceThicknessMapTransform))),g.transmission>0&&(y.transmission.value=g.transmission,y.transmissionSamplerMap.value=L.texture,y.transmissionSamplerSize.value.set(L.width,L.height),g.transmissionMap&&(y.transmissionMap.value=g.transmissionMap,t(g.transmissionMap,y.transmissionMapTransform)),y.thickness.value=g.thickness,g.thicknessMap&&(y.thicknessMap.value=g.thicknessMap,t(g.thicknessMap,y.thicknessMapTransform)),y.attenuationDistance.value=g.attenuationDistance,y.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(y.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(y.anisotropyMap.value=g.anisotropyMap,t(g.anisotropyMap,y.anisotropyMapTransform))),y.specularIntensity.value=g.specularIntensity,y.specularColor.value.copy(g.specularColor),g.specularColorMap&&(y.specularColorMap.value=g.specularColorMap,t(g.specularColorMap,y.specularColorMapTransform)),g.specularIntensityMap&&(y.specularIntensityMap.value=g.specularIntensityMap,t(g.specularIntensityMap,y.specularIntensityMapTransform))}function A(y,g){g.matcap&&(y.matcap.value=g.matcap)}function C(y,g){const L=e.get(g).light;y.referencePosition.value.setFromMatrixPosition(L.matrixWorld),y.nearDistance.value=L.shadow.camera.near,y.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:a}}function NM(s,e,t,r){let a={},u={},c=[];const d=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(L,b){const R=b.program;r.uniformBlockBinding(L,R)}function m(L,b){let R=a[L.id];R===void 0&&(A(L),R=_(L),a[L.id]=R,L.addEventListener("dispose",y));const Y=b.program;r.updateUBOMapping(L,Y);const O=e.render.frame;u[L.id]!==O&&(v(L),u[L.id]=O)}function _(L){const b=x();L.__bindingPointIndex=b;const R=s.createBuffer(),Y=L.__size,O=L.usage;return s.bindBuffer(s.UNIFORM_BUFFER,R),s.bufferData(s.UNIFORM_BUFFER,Y,O),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,b,R),R}function x(){for(let L=0;L<d;L++)if(c.indexOf(L)===-1)return c.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(L){const b=a[L.id],R=L.uniforms,Y=L.__cache;s.bindBuffer(s.UNIFORM_BUFFER,b);for(let O=0,I=R.length;O<I;O++){const V=Array.isArray(R[O])?R[O]:[R[O]];for(let P=0,T=V.length;P<T;P++){const k=V[P];if(S(k,O,P,Y)===!0){const se=k.__offset,te=Array.isArray(k.value)?k.value:[k.value];let fe=0;for(let he=0;he<te.length;he++){const oe=te[he],le=C(oe);typeof oe=="number"||typeof oe=="boolean"?(k.__data[0]=oe,s.bufferSubData(s.UNIFORM_BUFFER,se+fe,k.__data)):oe.isMatrix3?(k.__data[0]=oe.elements[0],k.__data[1]=oe.elements[1],k.__data[2]=oe.elements[2],k.__data[3]=0,k.__data[4]=oe.elements[3],k.__data[5]=oe.elements[4],k.__data[6]=oe.elements[5],k.__data[7]=0,k.__data[8]=oe.elements[6],k.__data[9]=oe.elements[7],k.__data[10]=oe.elements[8],k.__data[11]=0):(oe.toArray(k.__data,fe),fe+=le.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,se,k.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(L,b,R,Y){const O=L.value,I=b+"_"+R;if(Y[I]===void 0)return typeof O=="number"||typeof O=="boolean"?Y[I]=O:Y[I]=O.clone(),!0;{const V=Y[I];if(typeof O=="number"||typeof O=="boolean"){if(V!==O)return Y[I]=O,!0}else if(V.equals(O)===!1)return V.copy(O),!0}return!1}function A(L){const b=L.uniforms;let R=0;const Y=16;for(let I=0,V=b.length;I<V;I++){const P=Array.isArray(b[I])?b[I]:[b[I]];for(let T=0,k=P.length;T<k;T++){const se=P[T],te=Array.isArray(se.value)?se.value:[se.value];for(let fe=0,he=te.length;fe<he;fe++){const oe=te[fe],le=C(oe),B=R%Y,ae=B%le.boundary,re=B+ae;R+=ae,re!==0&&Y-re<le.storage&&(R+=Y-re),se.__data=new Float32Array(le.storage/Float32Array.BYTES_PER_ELEMENT),se.__offset=R,R+=le.storage}}}const O=R%Y;return O>0&&(R+=Y-O),L.__size=R,L.__cache={},this}function C(L){const b={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(b.boundary=4,b.storage=4):L.isVector2?(b.boundary=8,b.storage=8):L.isVector3||L.isColor?(b.boundary=16,b.storage=12):L.isVector4?(b.boundary=16,b.storage=16):L.isMatrix3?(b.boundary=48,b.storage=48):L.isMatrix4?(b.boundary=64,b.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),b}function y(L){const b=L.target;b.removeEventListener("dispose",y);const R=c.indexOf(b.__bindingPointIndex);c.splice(R,1),s.deleteBuffer(a[b.id]),delete a[b.id],delete u[b.id]}function g(){for(const L in a)s.deleteBuffer(a[L]);c=[],a={},u={}}return{bind:p,update:m,dispose:g}}class IM{constructor(e={}){const{canvas:t=E0(),context:r=null,depth:a=!0,stencil:u=!1,alpha:c=!1,antialias:d=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:x=!1,reverseDepthBuffer:v=!1}=e;this.isWebGLRenderer=!0;let S;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=r.getContextAttributes().alpha}else S=c;const A=new Uint32Array(4),C=new Int32Array(4);let y=null,g=null;const L=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Yn,this.toneMapping=Tr,this.toneMappingExposure=1;const R=this;let Y=!1,O=0,I=0,V=null,P=-1,T=null;const k=new Bt,se=new Bt;let te=null;const fe=new At(0);let he=0,oe=t.width,le=t.height,B=1,ae=null,re=null;const N=new Bt(0,0,oe,le),ne=new Bt(0,0,oe,le);let De=!1;const K=new ud;let ue=!1,Ee=!1;const ve=new zt,we=new zt,Ue=new Z,Ke=new Bt,Rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let dt=!1;function bt(){return V===null?B:1}let X=r;function hn(w,G){return t.getContext(w,G)}try{const w={alpha:!0,depth:a,stencil:u,antialias:d,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:_,failIfMajorPerformanceCaveat:x};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${td}`),t.addEventListener("webglcontextlost",de,!1),t.addEventListener("webglcontextrestored",be,!1),t.addEventListener("webglcontextcreationerror",Pe,!1),X===null){const G="webgl2";if(X=hn(G,w),X===null)throw hn(G)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let ft,lt,Ye,Tt,qe,D,M,$,pe,ge,ce,Ve,Ae,Ne,at,ye,Fe,Ze,Qe,Oe,ut,nt,Mt,H;function Re(){ft=new zS(X),ft.init(),nt=new wM(X,ft),lt=new NS(X,ft,e,nt),Ye=new EM(X,ft),lt.reverseDepthBuffer&&v&&Ye.buffers.depth.setReversed(!0),Tt=new GS(X),qe=new aM,D=new TM(X,ft,Ye,qe,lt,nt,Tt),M=new FS(R),$=new BS(R),pe=new K0(X),Mt=new DS(X,pe),ge=new VS(X,pe,Tt,Mt),ce=new XS(X,ge,pe,Tt),Qe=new WS(X,lt,D),ye=new IS(qe),Ve=new oM(R,M,$,ft,lt,Mt,ye),Ae=new UM(R,qe),Ne=new uM,at=new mM(ft),Ze=new LS(R,M,$,Ye,ce,S,p),Fe=new yM(R,ce,lt),H=new NM(X,Tt,lt,Ye),Oe=new US(X,ft,Tt),ut=new HS(X,ft,Tt),Tt.programs=Ve.programs,R.capabilities=lt,R.extensions=ft,R.properties=qe,R.renderLists=Ne,R.shadowMap=Fe,R.state=Ye,R.info=Tt}Re();const ie=new LM(R,X);this.xr=ie,this.getContext=function(){return X},this.getContextAttributes=function(){return X.getContextAttributes()},this.forceContextLoss=function(){const w=ft.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=ft.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return B},this.setPixelRatio=function(w){w!==void 0&&(B=w,this.setSize(oe,le,!1))},this.getSize=function(w){return w.set(oe,le)},this.setSize=function(w,G,J=!0){if(ie.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}oe=w,le=G,t.width=Math.floor(w*B),t.height=Math.floor(G*B),J===!0&&(t.style.width=w+"px",t.style.height=G+"px"),this.setViewport(0,0,w,G)},this.getDrawingBufferSize=function(w){return w.set(oe*B,le*B).floor()},this.setDrawingBufferSize=function(w,G,J){oe=w,le=G,B=J,t.width=Math.floor(w*J),t.height=Math.floor(G*J),this.setViewport(0,0,w,G)},this.getCurrentViewport=function(w){return w.copy(k)},this.getViewport=function(w){return w.copy(N)},this.setViewport=function(w,G,J,ee){w.isVector4?N.set(w.x,w.y,w.z,w.w):N.set(w,G,J,ee),Ye.viewport(k.copy(N).multiplyScalar(B).round())},this.getScissor=function(w){return w.copy(ne)},this.setScissor=function(w,G,J,ee){w.isVector4?ne.set(w.x,w.y,w.z,w.w):ne.set(w,G,J,ee),Ye.scissor(se.copy(ne).multiplyScalar(B).round())},this.getScissorTest=function(){return De},this.setScissorTest=function(w){Ye.setScissorTest(De=w)},this.setOpaqueSort=function(w){ae=w},this.setTransparentSort=function(w){re=w},this.getClearColor=function(w){return w.copy(Ze.getClearColor())},this.setClearColor=function(){Ze.setClearColor.apply(Ze,arguments)},this.getClearAlpha=function(){return Ze.getClearAlpha()},this.setClearAlpha=function(){Ze.setClearAlpha.apply(Ze,arguments)},this.clear=function(w=!0,G=!0,J=!0){let ee=0;if(w){let W=!1;if(V!==null){const Te=V.texture.format;W=Te===ad||Te===od||Te===sd}if(W){const Te=V.texture.type,Se=Te===qi||Te===es||Te===Ho||Te===Ys||Te===id||Te===rd,He=Ze.getClearColor(),Be=Ze.getClearAlpha(),Je=He.r,tt=He.g,Ge=He.b;Se?(A[0]=Je,A[1]=tt,A[2]=Ge,A[3]=Be,X.clearBufferuiv(X.COLOR,0,A)):(C[0]=Je,C[1]=tt,C[2]=Ge,C[3]=Be,X.clearBufferiv(X.COLOR,0,C))}else ee|=X.COLOR_BUFFER_BIT}G&&(ee|=X.DEPTH_BUFFER_BIT),J&&(ee|=X.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),X.clear(ee)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",de,!1),t.removeEventListener("webglcontextrestored",be,!1),t.removeEventListener("webglcontextcreationerror",Pe,!1),Ne.dispose(),at.dispose(),qe.dispose(),M.dispose(),$.dispose(),ce.dispose(),Mt.dispose(),H.dispose(),Ve.dispose(),ie.dispose(),ie.removeEventListener("sessionstart",ns),ie.removeEventListener("sessionend",$i),wi.stop()};function de(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),Y=!0}function be(){console.log("THREE.WebGLRenderer: Context Restored."),Y=!1;const w=Tt.autoReset,G=Fe.enabled,J=Fe.autoUpdate,ee=Fe.needsUpdate,W=Fe.type;Re(),Tt.autoReset=w,Fe.enabled=G,Fe.autoUpdate=J,Fe.needsUpdate=ee,Fe.type=W}function Pe(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function it(w){const G=w.target;G.removeEventListener("dispose",it),Dt(G)}function Dt(w){Xt(w),qe.remove(w)}function Xt(w){const G=qe.get(w).programs;G!==void 0&&(G.forEach(function(J){Ve.releaseProgram(J)}),w.isShaderMaterial&&Ve.releaseShaderCache(w))}this.renderBufferDirect=function(w,G,J,ee,W,Te){G===null&&(G=Rt);const Se=W.isMesh&&W.matrixWorld.determinant()<0,He=Ko(w,G,J,ee,W);Ye.setMaterial(ee,Se);let Be=J.index,Je=1;if(ee.wireframe===!0){if(Be=ge.getWireframeAttribute(J),Be===void 0)return;Je=2}const tt=J.drawRange,Ge=J.attributes.position;let pt=tt.start*Je,Et=(tt.start+tt.count)*Je;Te!==null&&(pt=Math.max(pt,Te.start*Je),Et=Math.min(Et,(Te.start+Te.count)*Je)),Be!==null?(pt=Math.max(pt,0),Et=Math.min(Et,Be.count)):Ge!=null&&(pt=Math.max(pt,0),Et=Math.min(Et,Ge.count));const ht=Et-pt;if(ht<0||ht===1/0)return;Mt.setup(W,ee,He,J,Be);let rn,rt=Oe;if(Be!==null&&(rn=pe.get(Be),rt=ut,rt.setIndex(rn)),W.isMesh)ee.wireframe===!0?(Ye.setLineWidth(ee.wireframeLinewidth*bt()),rt.setMode(X.LINES)):rt.setMode(X.TRIANGLES);else if(W.isLine){let Xe=ee.linewidth;Xe===void 0&&(Xe=1),Ye.setLineWidth(Xe*bt()),W.isLineSegments?rt.setMode(X.LINES):W.isLineLoop?rt.setMode(X.LINE_LOOP):rt.setMode(X.LINE_STRIP)}else W.isPoints?rt.setMode(X.POINTS):W.isSprite&&rt.setMode(X.TRIANGLES);if(W.isBatchedMesh)if(W._multiDrawInstances!==null)rt.renderMultiDrawInstances(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount,W._multiDrawInstances);else if(ft.get("WEBGL_multi_draw"))rt.renderMultiDraw(W._multiDrawStarts,W._multiDrawCounts,W._multiDrawCount);else{const Xe=W._multiDrawStarts,Kn=W._multiDrawCounts,xt=W._multiDrawCount,sn=Be?pe.get(Be).bytesPerElement:1,Zn=qe.get(ee).currentProgram.getUniforms();for(let qt=0;qt<xt;qt++)Zn.setValue(X,"_gl_DrawID",qt),rt.render(Xe[qt]/sn,Kn[qt])}else if(W.isInstancedMesh)rt.renderInstances(pt,ht,W.count);else if(J.isInstancedBufferGeometry){const Xe=J._maxInstanceCount!==void 0?J._maxInstanceCount:1/0,Kn=Math.min(J.instanceCount,Xe);rt.renderInstances(pt,ht,Kn)}else rt.render(pt,ht)};function gt(w,G,J){w.transparent===!0&&w.side===Hi&&w.forceSinglePass===!1?(w.side=Pn,w.needsUpdate=!0,is(w,G,J),w.side=Ar,w.needsUpdate=!0,is(w,G,J),w.side=Hi):is(w,G,J)}this.compile=function(w,G,J=null){J===null&&(J=w),g=at.get(J),g.init(G),b.push(g),J.traverseVisible(function(W){W.isLight&&W.layers.test(G.layers)&&(g.pushLight(W),W.castShadow&&g.pushShadow(W))}),w!==J&&w.traverseVisible(function(W){W.isLight&&W.layers.test(G.layers)&&(g.pushLight(W),W.castShadow&&g.pushShadow(W))}),g.setupLights();const ee=new Set;return w.traverse(function(W){if(!(W.isMesh||W.isPoints||W.isLine||W.isSprite))return;const Te=W.material;if(Te)if(Array.isArray(Te))for(let Se=0;Se<Te.length;Se++){const He=Te[Se];gt(He,J,W),ee.add(He)}else gt(Te,J,W),ee.add(Te)}),b.pop(),g=null,ee},this.compileAsync=function(w,G,J=null){const ee=this.compile(w,G,J);return new Promise(W=>{function Te(){if(ee.forEach(function(Se){qe.get(Se).currentProgram.isReady()&&ee.delete(Se)}),ee.size===0){W(w);return}setTimeout(Te,10)}ft.get("KHR_parallel_shader_compile")!==null?Te():setTimeout(Te,10)})};let xn=null;function pn(w){xn&&xn(w)}function ns(){wi.stop()}function $i(){wi.start()}const wi=new wg;wi.setAnimationLoop(pn),typeof self<"u"&&wi.setContext(self),this.setAnimationLoop=function(w){xn=w,ie.setAnimationLoop(w),w===null?wi.stop():wi.start()},ie.addEventListener("sessionstart",ns),ie.addEventListener("sessionend",$i),this.render=function(w,G){if(G!==void 0&&G.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(Y===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),ie.enabled===!0&&ie.isPresenting===!0&&(ie.cameraAutoUpdate===!0&&ie.updateCamera(G),G=ie.getCamera()),w.isScene===!0&&w.onBeforeRender(R,w,G,V),g=at.get(w,b.length),g.init(G),b.push(g),we.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),K.setFromProjectionMatrix(we),Ee=this.localClippingEnabled,ue=ye.init(this.clippingPlanes,Ee),y=Ne.get(w,L.length),y.init(),L.push(y),ie.enabled===!0&&ie.isPresenting===!0){const Te=R.xr.getDepthSensingMesh();Te!==null&&Ai(Te,G,-1/0,R.sortObjects)}Ai(w,G,0,R.sortObjects),y.finish(),R.sortObjects===!0&&y.sort(ae,re),dt=ie.enabled===!1||ie.isPresenting===!1||ie.hasDepthSensing()===!1,dt&&Ze.addToRenderList(y,w),this.info.render.frame++,ue===!0&&ye.beginShadows();const J=g.state.shadowsArray;Fe.render(J,w,G),ue===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset();const ee=y.opaque,W=y.transmissive;if(g.setupLights(),G.isArrayCamera){const Te=G.cameras;if(W.length>0)for(let Se=0,He=Te.length;Se<He;Se++){const Be=Te[Se];Pr(ee,W,w,Be)}dt&&Ze.render(w);for(let Se=0,He=Te.length;Se<He;Se++){const Be=Te[Se];Cr(y,w,Be,Be.viewport)}}else W.length>0&&Pr(ee,W,w,G),dt&&Ze.render(w),Cr(y,w,G);V!==null&&(D.updateMultisampleRenderTarget(V),D.updateRenderTargetMipmap(V)),w.isScene===!0&&w.onAfterRender(R,w,G),Mt.resetDefaultState(),P=-1,T=null,b.pop(),b.length>0?(g=b[b.length-1],ue===!0&&ye.setGlobalState(R.clippingPlanes,g.state.camera)):g=null,L.pop(),L.length>0?y=L[L.length-1]:y=null};function Ai(w,G,J,ee){if(w.visible===!1)return;if(w.layers.test(G.layers)){if(w.isGroup)J=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(G);else if(w.isLight)g.pushLight(w),w.castShadow&&g.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||K.intersectsSprite(w)){ee&&Ke.setFromMatrixPosition(w.matrixWorld).applyMatrix4(we);const Se=ce.update(w),He=w.material;He.visible&&y.push(w,Se,He,J,Ke.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||K.intersectsObject(w))){const Se=ce.update(w),He=w.material;if(ee&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Ke.copy(w.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Ke.copy(Se.boundingSphere.center)),Ke.applyMatrix4(w.matrixWorld).applyMatrix4(we)),Array.isArray(He)){const Be=Se.groups;for(let Je=0,tt=Be.length;Je<tt;Je++){const Ge=Be[Je],pt=He[Ge.materialIndex];pt&&pt.visible&&y.push(w,Se,pt,J,Ke.z,Ge)}}else He.visible&&y.push(w,Se,He,J,Ke.z,null)}}const Te=w.children;for(let Se=0,He=Te.length;Se<He;Se++)Ai(Te[Se],G,J,ee)}function Cr(w,G,J,ee){const W=w.opaque,Te=w.transmissive,Se=w.transparent;g.setupLightsView(J),ue===!0&&ye.setGlobalState(R.clippingPlanes,J),ee&&Ye.viewport(k.copy(ee)),W.length>0&&Ki(W,G,J),Te.length>0&&Ki(Te,G,J),Se.length>0&&Ki(Se,G,J),Ye.buffers.depth.setTest(!0),Ye.buffers.depth.setMask(!0),Ye.buffers.color.setMask(!0),Ye.setPolygonOffset(!1)}function Pr(w,G,J,ee){if((J.isScene===!0?J.overrideMaterial:null)!==null)return;g.state.transmissionRenderTarget[ee.id]===void 0&&(g.state.transmissionRenderTarget[ee.id]=new ts(1,1,{generateMipmaps:!0,type:ft.has("EXT_color_buffer_half_float")||ft.has("EXT_color_buffer_float")?Go:qi,minFilter:Jr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace}));const Te=g.state.transmissionRenderTarget[ee.id],Se=ee.viewport||k;Te.setSize(Se.z,Se.w);const He=R.getRenderTarget();R.setRenderTarget(Te),R.getClearColor(fe),he=R.getClearAlpha(),he<1&&R.setClearColor(16777215,.5),R.clear(),dt&&Ze.render(J);const Be=R.toneMapping;R.toneMapping=Tr;const Je=ee.viewport;if(ee.viewport!==void 0&&(ee.viewport=void 0),g.setupLightsView(ee),ue===!0&&ye.setGlobalState(R.clippingPlanes,ee),Ki(w,J,ee),D.updateMultisampleRenderTarget(Te),D.updateRenderTargetMipmap(Te),ft.has("WEBGL_multisampled_render_to_texture")===!1){let tt=!1;for(let Ge=0,pt=G.length;Ge<pt;Ge++){const Et=G[Ge],ht=Et.object,rn=Et.geometry,rt=Et.material,Xe=Et.group;if(rt.side===Hi&&ht.layers.test(ee.layers)){const Kn=rt.side;rt.side=Pn,rt.needsUpdate=!0,jo(ht,J,ee,rn,rt,Xe),rt.side=Kn,rt.needsUpdate=!0,tt=!0}}tt===!0&&(D.updateMultisampleRenderTarget(Te),D.updateRenderTargetMipmap(Te))}R.setRenderTarget(He),R.setClearColor(fe,he),Je!==void 0&&(ee.viewport=Je),R.toneMapping=Be}function Ki(w,G,J){const ee=G.isScene===!0?G.overrideMaterial:null;for(let W=0,Te=w.length;W<Te;W++){const Se=w[W],He=Se.object,Be=Se.geometry,Je=ee===null?Se.material:ee,tt=Se.group;He.layers.test(J.layers)&&jo(He,G,J,Be,Je,tt)}}function jo(w,G,J,ee,W,Te){w.onBeforeRender(R,G,J,ee,W,Te),w.modelViewMatrix.multiplyMatrices(J.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),W.onBeforeRender(R,G,J,ee,w,Te),W.transparent===!0&&W.side===Hi&&W.forceSinglePass===!1?(W.side=Pn,W.needsUpdate=!0,R.renderBufferDirect(J,G,ee,W,w,Te),W.side=Ar,W.needsUpdate=!0,R.renderBufferDirect(J,G,ee,W,w,Te),W.side=Hi):R.renderBufferDirect(J,G,ee,W,w,Te),w.onAfterRender(R,G,J,ee,W,Te)}function is(w,G,J){G.isScene!==!0&&(G=Rt);const ee=qe.get(w),W=g.state.lights,Te=g.state.shadowsArray,Se=W.state.version,He=Ve.getParameters(w,W.state,Te,G,J),Be=Ve.getProgramCacheKey(He);let Je=ee.programs;ee.environment=w.isMeshStandardMaterial?G.environment:null,ee.fog=G.fog,ee.envMap=(w.isMeshStandardMaterial?$:M).get(w.envMap||ee.environment),ee.envMapRotation=ee.environment!==null&&w.envMap===null?G.environmentRotation:w.envMapRotation,Je===void 0&&(w.addEventListener("dispose",it),Je=new Map,ee.programs=Je);let tt=Je.get(Be);if(tt!==void 0){if(ee.currentProgram===tt&&ee.lightsStateVersion===Se)return di(w,He),tt}else He.uniforms=Ve.getUniforms(w),w.onBeforeCompile(He,R),tt=Ve.acquireProgram(He,Be),Je.set(Be,tt),ee.uniforms=He.uniforms;const Ge=ee.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Ge.clippingPlanes=ye.uniform),di(w,He),ee.needsLights=Wl(w),ee.lightsStateVersion=Se,ee.needsLights&&(Ge.ambientLightColor.value=W.state.ambient,Ge.lightProbe.value=W.state.probe,Ge.directionalLights.value=W.state.directional,Ge.directionalLightShadows.value=W.state.directionalShadow,Ge.spotLights.value=W.state.spot,Ge.spotLightShadows.value=W.state.spotShadow,Ge.rectAreaLights.value=W.state.rectArea,Ge.ltc_1.value=W.state.rectAreaLTC1,Ge.ltc_2.value=W.state.rectAreaLTC2,Ge.pointLights.value=W.state.point,Ge.pointLightShadows.value=W.state.pointShadow,Ge.hemisphereLights.value=W.state.hemi,Ge.directionalShadowMap.value=W.state.directionalShadowMap,Ge.directionalShadowMatrix.value=W.state.directionalShadowMatrix,Ge.spotShadowMap.value=W.state.spotShadowMap,Ge.spotLightMatrix.value=W.state.spotLightMatrix,Ge.spotLightMap.value=W.state.spotLightMap,Ge.pointShadowMap.value=W.state.pointShadowMap,Ge.pointShadowMatrix.value=W.state.pointShadowMatrix),ee.currentProgram=tt,ee.uniformsList=null,tt}function $o(w){if(w.uniformsList===null){const G=w.currentProgram.getUniforms();w.uniformsList=Pl.seqWithValue(G.seq,w.uniforms)}return w.uniformsList}function di(w,G){const J=qe.get(w);J.outputColorSpace=G.outputColorSpace,J.batching=G.batching,J.batchingColor=G.batchingColor,J.instancing=G.instancing,J.instancingColor=G.instancingColor,J.instancingMorph=G.instancingMorph,J.skinning=G.skinning,J.morphTargets=G.morphTargets,J.morphNormals=G.morphNormals,J.morphColors=G.morphColors,J.morphTargetsCount=G.morphTargetsCount,J.numClippingPlanes=G.numClippingPlanes,J.numIntersection=G.numClipIntersection,J.vertexAlphas=G.vertexAlphas,J.vertexTangents=G.vertexTangents,J.toneMapping=G.toneMapping}function Ko(w,G,J,ee,W){G.isScene!==!0&&(G=Rt),D.resetTextureUnits();const Te=G.fog,Se=ee.isMeshStandardMaterial?G.environment:null,He=V===null?R.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:Ks,Be=(ee.isMeshStandardMaterial?$:M).get(ee.envMap||Se),Je=ee.vertexColors===!0&&!!J.attributes.color&&J.attributes.color.itemSize===4,tt=!!J.attributes.tangent&&(!!ee.normalMap||ee.anisotropy>0),Ge=!!J.morphAttributes.position,pt=!!J.morphAttributes.normal,Et=!!J.morphAttributes.color;let ht=Tr;ee.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(ht=R.toneMapping);const rn=J.morphAttributes.position||J.morphAttributes.normal||J.morphAttributes.color,rt=rn!==void 0?rn.length:0,Xe=qe.get(ee),Kn=g.state.lights;if(ue===!0&&(Ee===!0||w!==T)){const mn=w===T&&ee.id===P;ye.setState(ee,w,mn)}let xt=!1;ee.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==Kn.state.version||Xe.outputColorSpace!==He||W.isBatchedMesh&&Xe.batching===!1||!W.isBatchedMesh&&Xe.batching===!0||W.isBatchedMesh&&Xe.batchingColor===!0&&W.colorTexture===null||W.isBatchedMesh&&Xe.batchingColor===!1&&W.colorTexture!==null||W.isInstancedMesh&&Xe.instancing===!1||!W.isInstancedMesh&&Xe.instancing===!0||W.isSkinnedMesh&&Xe.skinning===!1||!W.isSkinnedMesh&&Xe.skinning===!0||W.isInstancedMesh&&Xe.instancingColor===!0&&W.instanceColor===null||W.isInstancedMesh&&Xe.instancingColor===!1&&W.instanceColor!==null||W.isInstancedMesh&&Xe.instancingMorph===!0&&W.morphTexture===null||W.isInstancedMesh&&Xe.instancingMorph===!1&&W.morphTexture!==null||Xe.envMap!==Be||ee.fog===!0&&Xe.fog!==Te||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==ye.numPlanes||Xe.numIntersection!==ye.numIntersection)||Xe.vertexAlphas!==Je||Xe.vertexTangents!==tt||Xe.morphTargets!==Ge||Xe.morphNormals!==pt||Xe.morphColors!==Et||Xe.toneMapping!==ht||Xe.morphTargetsCount!==rt)&&(xt=!0):(xt=!0,Xe.__version=ee.version);let sn=Xe.currentProgram;xt===!0&&(sn=is(ee,G,W));let Zn=!1,qt=!1,hi=!1;const Pt=sn.getUniforms(),On=Xe.uniforms;if(Ye.useProgram(sn.program)&&(Zn=!0,qt=!0,hi=!0),ee.id!==P&&(P=ee.id,qt=!0),Zn||T!==w){Ye.buffers.depth.getReversed()?(ve.copy(w.projectionMatrix),T0(ve),w0(ve),Pt.setValue(X,"projectionMatrix",ve)):Pt.setValue(X,"projectionMatrix",w.projectionMatrix),Pt.setValue(X,"viewMatrix",w.matrixWorldInverse);const kn=Pt.map.cameraPosition;kn!==void 0&&kn.setValue(X,Ue.setFromMatrixPosition(w.matrixWorld)),lt.logarithmicDepthBuffer&&Pt.setValue(X,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(ee.isMeshPhongMaterial||ee.isMeshToonMaterial||ee.isMeshLambertMaterial||ee.isMeshBasicMaterial||ee.isMeshStandardMaterial||ee.isShaderMaterial)&&Pt.setValue(X,"isOrthographic",w.isOrthographicCamera===!0),T!==w&&(T=w,qt=!0,hi=!0)}if(W.isSkinnedMesh){Pt.setOptional(X,W,"bindMatrix"),Pt.setOptional(X,W,"bindMatrixInverse");const mn=W.skeleton;mn&&(mn.boneTexture===null&&mn.computeBoneTexture(),Pt.setValue(X,"boneTexture",mn.boneTexture,D))}W.isBatchedMesh&&(Pt.setOptional(X,W,"batchingTexture"),Pt.setValue(X,"batchingTexture",W._matricesTexture,D),Pt.setOptional(X,W,"batchingIdTexture"),Pt.setValue(X,"batchingIdTexture",W._indirectTexture,D),Pt.setOptional(X,W,"batchingColorTexture"),W._colorsTexture!==null&&Pt.setValue(X,"batchingColorTexture",W._colorsTexture,D));const Ri=J.morphAttributes;if((Ri.position!==void 0||Ri.normal!==void 0||Ri.color!==void 0)&&Qe.update(W,J,sn),(qt||Xe.receiveShadow!==W.receiveShadow)&&(Xe.receiveShadow=W.receiveShadow,Pt.setValue(X,"receiveShadow",W.receiveShadow)),ee.isMeshGouraudMaterial&&ee.envMap!==null&&(On.envMap.value=Be,On.flipEnvMap.value=Be.isCubeTexture&&Be.isRenderTargetTexture===!1?-1:1),ee.isMeshStandardMaterial&&ee.envMap===null&&G.environment!==null&&(On.envMapIntensity.value=G.environmentIntensity),qt&&(Pt.setValue(X,"toneMappingExposure",R.toneMappingExposure),Xe.needsLights&&Zo(On,hi),Te&&ee.fog===!0&&Ae.refreshFogUniforms(On,Te),Ae.refreshMaterialUniforms(On,ee,B,le,g.state.transmissionRenderTarget[w.id]),Pl.upload(X,$o(Xe),On,D)),ee.isShaderMaterial&&ee.uniformsNeedUpdate===!0&&(Pl.upload(X,$o(Xe),On,D),ee.uniformsNeedUpdate=!1),ee.isSpriteMaterial&&Pt.setValue(X,"center",W.center),Pt.setValue(X,"modelViewMatrix",W.modelViewMatrix),Pt.setValue(X,"normalMatrix",W.normalMatrix),Pt.setValue(X,"modelMatrix",W.matrixWorld),ee.isShaderMaterial||ee.isRawShaderMaterial){const mn=ee.uniformsGroups;for(let kn=0,yn=mn.length;kn<yn;kn++){const Qo=mn[kn];H.update(Qo,sn),H.bind(Qo,sn)}}return sn}function Zo(w,G){w.ambientLightColor.needsUpdate=G,w.lightProbe.needsUpdate=G,w.directionalLights.needsUpdate=G,w.directionalLightShadows.needsUpdate=G,w.pointLights.needsUpdate=G,w.pointLightShadows.needsUpdate=G,w.spotLights.needsUpdate=G,w.spotLightShadows.needsUpdate=G,w.rectAreaLights.needsUpdate=G,w.hemisphereLights.needsUpdate=G}function Wl(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(w,G,J){qe.get(w.texture).__webglTexture=G,qe.get(w.depthTexture).__webglTexture=J;const ee=qe.get(w);ee.__hasExternalTextures=!0,ee.__autoAllocateDepthBuffer=J===void 0,ee.__autoAllocateDepthBuffer||ft.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ee.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,G){const J=qe.get(w);J.__webglFramebuffer=G,J.__useDefaultFramebuffer=G===void 0},this.setRenderTarget=function(w,G=0,J=0){V=w,O=G,I=J;let ee=!0,W=null,Te=!1,Se=!1;if(w){const Be=qe.get(w);if(Be.__useDefaultFramebuffer!==void 0)Ye.bindFramebuffer(X.FRAMEBUFFER,null),ee=!1;else if(Be.__webglFramebuffer===void 0)D.setupRenderTarget(w);else if(Be.__hasExternalTextures)D.rebindTextures(w,qe.get(w.texture).__webglTexture,qe.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const Ge=w.depthTexture;if(Be.__boundDepthTexture!==Ge){if(Ge!==null&&qe.has(Ge)&&(w.width!==Ge.image.width||w.height!==Ge.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");D.setupDepthRenderbuffer(w)}}const Je=w.texture;(Je.isData3DTexture||Je.isDataArrayTexture||Je.isCompressedArrayTexture)&&(Se=!0);const tt=qe.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(tt[G])?W=tt[G][J]:W=tt[G],Te=!0):w.samples>0&&D.useMultisampledRTT(w)===!1?W=qe.get(w).__webglMultisampledFramebuffer:Array.isArray(tt)?W=tt[J]:W=tt,k.copy(w.viewport),se.copy(w.scissor),te=w.scissorTest}else k.copy(N).multiplyScalar(B).floor(),se.copy(ne).multiplyScalar(B).floor(),te=De;if(Ye.bindFramebuffer(X.FRAMEBUFFER,W)&&ee&&Ye.drawBuffers(w,W),Ye.viewport(k),Ye.scissor(se),Ye.setScissorTest(te),Te){const Be=qe.get(w.texture);X.framebufferTexture2D(X.FRAMEBUFFER,X.COLOR_ATTACHMENT0,X.TEXTURE_CUBE_MAP_POSITIVE_X+G,Be.__webglTexture,J)}else if(Se){const Be=qe.get(w.texture),Je=G||0;X.framebufferTextureLayer(X.FRAMEBUFFER,X.COLOR_ATTACHMENT0,Be.__webglTexture,J||0,Je)}P=-1},this.readRenderTargetPixels=function(w,G,J,ee,W,Te,Se){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let He=qe.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Se!==void 0&&(He=He[Se]),He){Ye.bindFramebuffer(X.FRAMEBUFFER,He);try{const Be=w.texture,Je=Be.format,tt=Be.type;if(!lt.textureFormatReadable(Je)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!lt.textureTypeReadable(tt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=w.width-ee&&J>=0&&J<=w.height-W&&X.readPixels(G,J,ee,W,nt.convert(Je),nt.convert(tt),Te)}finally{const Be=V!==null?qe.get(V).__webglFramebuffer:null;Ye.bindFramebuffer(X.FRAMEBUFFER,Be)}}},this.readRenderTargetPixelsAsync=async function(w,G,J,ee,W,Te,Se){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let He=qe.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Se!==void 0&&(He=He[Se]),He){const Be=w.texture,Je=Be.format,tt=Be.type;if(!lt.textureFormatReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!lt.textureTypeReadable(tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(G>=0&&G<=w.width-ee&&J>=0&&J<=w.height-W){Ye.bindFramebuffer(X.FRAMEBUFFER,He);const Ge=X.createBuffer();X.bindBuffer(X.PIXEL_PACK_BUFFER,Ge),X.bufferData(X.PIXEL_PACK_BUFFER,Te.byteLength,X.STREAM_READ),X.readPixels(G,J,ee,W,nt.convert(Je),nt.convert(tt),0);const pt=V!==null?qe.get(V).__webglFramebuffer:null;Ye.bindFramebuffer(X.FRAMEBUFFER,pt);const Et=X.fenceSync(X.SYNC_GPU_COMMANDS_COMPLETE,0);return X.flush(),await M0(X,Et,4),X.bindBuffer(X.PIXEL_PACK_BUFFER,Ge),X.getBufferSubData(X.PIXEL_PACK_BUFFER,0,Te),X.deleteBuffer(Ge),X.deleteSync(Et),Te}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(w,G=null,J=0){w.isTexture!==!0&&(Bo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),G=arguments[0]||null,w=arguments[1]);const ee=Math.pow(2,-J),W=Math.floor(w.image.width*ee),Te=Math.floor(w.image.height*ee),Se=G!==null?G.x:0,He=G!==null?G.y:0;D.setTexture2D(w,0),X.copyTexSubImage2D(X.TEXTURE_2D,J,0,0,Se,He,W,Te),Ye.unbindTexture()},this.copyTextureToTexture=function(w,G,J=null,ee=null,W=0){w.isTexture!==!0&&(Bo("WebGLRenderer: copyTextureToTexture function signature has changed."),ee=arguments[0]||null,w=arguments[1],G=arguments[2],W=arguments[3]||0,J=null);let Te,Se,He,Be,Je,tt,Ge,pt,Et;const ht=w.isCompressedTexture?w.mipmaps[W]:w.image;J!==null?(Te=J.max.x-J.min.x,Se=J.max.y-J.min.y,He=J.isBox3?J.max.z-J.min.z:1,Be=J.min.x,Je=J.min.y,tt=J.isBox3?J.min.z:0):(Te=ht.width,Se=ht.height,He=ht.depth||1,Be=0,Je=0,tt=0),ee!==null?(Ge=ee.x,pt=ee.y,Et=ee.z):(Ge=0,pt=0,Et=0);const rn=nt.convert(G.format),rt=nt.convert(G.type);let Xe;G.isData3DTexture?(D.setTexture3D(G,0),Xe=X.TEXTURE_3D):G.isDataArrayTexture||G.isCompressedArrayTexture?(D.setTexture2DArray(G,0),Xe=X.TEXTURE_2D_ARRAY):(D.setTexture2D(G,0),Xe=X.TEXTURE_2D),X.pixelStorei(X.UNPACK_FLIP_Y_WEBGL,G.flipY),X.pixelStorei(X.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),X.pixelStorei(X.UNPACK_ALIGNMENT,G.unpackAlignment);const Kn=X.getParameter(X.UNPACK_ROW_LENGTH),xt=X.getParameter(X.UNPACK_IMAGE_HEIGHT),sn=X.getParameter(X.UNPACK_SKIP_PIXELS),Zn=X.getParameter(X.UNPACK_SKIP_ROWS),qt=X.getParameter(X.UNPACK_SKIP_IMAGES);X.pixelStorei(X.UNPACK_ROW_LENGTH,ht.width),X.pixelStorei(X.UNPACK_IMAGE_HEIGHT,ht.height),X.pixelStorei(X.UNPACK_SKIP_PIXELS,Be),X.pixelStorei(X.UNPACK_SKIP_ROWS,Je),X.pixelStorei(X.UNPACK_SKIP_IMAGES,tt);const hi=w.isDataArrayTexture||w.isData3DTexture,Pt=G.isDataArrayTexture||G.isData3DTexture;if(w.isRenderTargetTexture||w.isDepthTexture){const On=qe.get(w),Ri=qe.get(G),mn=qe.get(On.__renderTarget),kn=qe.get(Ri.__renderTarget);Ye.bindFramebuffer(X.READ_FRAMEBUFFER,mn.__webglFramebuffer),Ye.bindFramebuffer(X.DRAW_FRAMEBUFFER,kn.__webglFramebuffer);for(let yn=0;yn<He;yn++)hi&&X.framebufferTextureLayer(X.READ_FRAMEBUFFER,X.COLOR_ATTACHMENT0,qe.get(w).__webglTexture,W,tt+yn),w.isDepthTexture?(Pt&&X.framebufferTextureLayer(X.DRAW_FRAMEBUFFER,X.COLOR_ATTACHMENT0,qe.get(G).__webglTexture,W,Et+yn),X.blitFramebuffer(Be,Je,Te,Se,Ge,pt,Te,Se,X.DEPTH_BUFFER_BIT,X.NEAREST)):Pt?X.copyTexSubImage3D(Xe,W,Ge,pt,Et+yn,Be,Je,Te,Se):X.copyTexSubImage2D(Xe,W,Ge,pt,Et+yn,Be,Je,Te,Se);Ye.bindFramebuffer(X.READ_FRAMEBUFFER,null),Ye.bindFramebuffer(X.DRAW_FRAMEBUFFER,null)}else Pt?w.isDataTexture||w.isData3DTexture?X.texSubImage3D(Xe,W,Ge,pt,Et,Te,Se,He,rn,rt,ht.data):G.isCompressedArrayTexture?X.compressedTexSubImage3D(Xe,W,Ge,pt,Et,Te,Se,He,rn,ht.data):X.texSubImage3D(Xe,W,Ge,pt,Et,Te,Se,He,rn,rt,ht):w.isDataTexture?X.texSubImage2D(X.TEXTURE_2D,W,Ge,pt,Te,Se,rn,rt,ht.data):w.isCompressedTexture?X.compressedTexSubImage2D(X.TEXTURE_2D,W,Ge,pt,ht.width,ht.height,rn,ht.data):X.texSubImage2D(X.TEXTURE_2D,W,Ge,pt,Te,Se,rn,rt,ht);X.pixelStorei(X.UNPACK_ROW_LENGTH,Kn),X.pixelStorei(X.UNPACK_IMAGE_HEIGHT,xt),X.pixelStorei(X.UNPACK_SKIP_PIXELS,sn),X.pixelStorei(X.UNPACK_SKIP_ROWS,Zn),X.pixelStorei(X.UNPACK_SKIP_IMAGES,qt),W===0&&G.generateMipmaps&&X.generateMipmap(Xe),Ye.unbindTexture()},this.copyTextureToTexture3D=function(w,G,J=null,ee=null,W=0){return w.isTexture!==!0&&(Bo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),J=arguments[0]||null,ee=arguments[1]||null,w=arguments[2],G=arguments[3],W=arguments[4]||0),Bo('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(w,G,J,ee,W)},this.initRenderTarget=function(w){qe.get(w).__webglFramebuffer===void 0&&D.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?D.setTextureCube(w,0):w.isData3DTexture?D.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?D.setTexture2DArray(w,0):D.setTexture2D(w,0),Ye.unbindTexture()},this.resetState=function(){O=0,I=0,V=null,Ye.reset(),Mt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Wi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=vt._getDrawingBufferColorSpace(e),t.unpackColorSpace=vt._getUnpackColorSpace()}}class FM extends dn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Yi,this.environmentIntensity=1,this.environmentRotation=new Yi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class fd extends Rr{constructor(e=[],t=[],r=1,a=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:e,indices:t,radius:r,detail:a};const u=[],c=[];d(a),m(r),_(),this.setAttribute("position",new Ei(u,3)),this.setAttribute("normal",new Ei(u.slice(),3)),this.setAttribute("uv",new Ei(c,2)),a===0?this.computeVertexNormals():this.normalizeNormals();function d(L){const b=new Z,R=new Z,Y=new Z;for(let O=0;O<t.length;O+=3)S(t[O+0],b),S(t[O+1],R),S(t[O+2],Y),p(b,R,Y,L)}function p(L,b,R,Y){const O=Y+1,I=[];for(let V=0;V<=O;V++){I[V]=[];const P=L.clone().lerp(R,V/O),T=b.clone().lerp(R,V/O),k=O-V;for(let se=0;se<=k;se++)se===0&&V===O?I[V][se]=P:I[V][se]=P.clone().lerp(T,se/k)}for(let V=0;V<O;V++)for(let P=0;P<2*(O-V)-1;P++){const T=Math.floor(P/2);P%2===0?(v(I[V][T+1]),v(I[V+1][T]),v(I[V][T])):(v(I[V][T+1]),v(I[V+1][T+1]),v(I[V+1][T]))}}function m(L){const b=new Z;for(let R=0;R<u.length;R+=3)b.x=u[R+0],b.y=u[R+1],b.z=u[R+2],b.normalize().multiplyScalar(L),u[R+0]=b.x,u[R+1]=b.y,u[R+2]=b.z}function _(){const L=new Z;for(let b=0;b<u.length;b+=3){L.x=u[b+0],L.y=u[b+1],L.z=u[b+2];const R=y(L)/2/Math.PI+.5,Y=g(L)/Math.PI+.5;c.push(R,1-Y)}A(),x()}function x(){for(let L=0;L<c.length;L+=6){const b=c[L+0],R=c[L+2],Y=c[L+4],O=Math.max(b,R,Y),I=Math.min(b,R,Y);O>.9&&I<.1&&(b<.2&&(c[L+0]+=1),R<.2&&(c[L+2]+=1),Y<.2&&(c[L+4]+=1))}}function v(L){u.push(L.x,L.y,L.z)}function S(L,b){const R=L*3;b.x=e[R+0],b.y=e[R+1],b.z=e[R+2]}function A(){const L=new Z,b=new Z,R=new Z,Y=new Z,O=new St,I=new St,V=new St;for(let P=0,T=0;P<u.length;P+=9,T+=6){L.set(u[P+0],u[P+1],u[P+2]),b.set(u[P+3],u[P+4],u[P+5]),R.set(u[P+6],u[P+7],u[P+8]),O.set(c[T+0],c[T+1]),I.set(c[T+2],c[T+3]),V.set(c[T+4],c[T+5]),Y.copy(L).add(b).add(R).divideScalar(3);const k=y(Y);C(O,T+0,L,k),C(I,T+2,b,k),C(V,T+4,R,k)}}function C(L,b,R,Y){Y<0&&L.x===1&&(c[b]=L.x-1),R.x===0&&R.z===0&&(c[b]=Y/2/Math.PI+.5)}function y(L){return Math.atan2(L.z,-L.x)}function g(L){return Math.atan2(-L.y,Math.sqrt(L.x*L.x+L.z*L.z))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new fd(e.vertices,e.indices,e.radius,e.details)}}class dd extends fd{constructor(e=1,t=0){const r=(1+Math.sqrt(5))/2,a=[-1,r,0,1,r,0,-1,-r,0,1,-r,0,0,-1,r,0,1,r,0,-1,-r,0,1,-r,r,0,-1,r,0,1,-r,0,-1,-r,0,1],u=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(a,u,e,t),this.type="IcosahedronGeometry",this.parameters={radius:e,detail:t}}static fromJSON(e){return new dd(e.radius,e.detail)}}class Dg extends dn{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new At(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const rf=new zt,Ym=new Z,jm=new Z;class OM{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new St(512,512),this.map=null,this.mapPass=null,this.matrix=new zt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new ud,this._frameExtents=new St(1,1),this._viewportCount=1,this._viewports=[new Bt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,r=this.matrix;Ym.setFromMatrixPosition(e.matrixWorld),t.position.copy(Ym),jm.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(jm),t.updateMatrixWorld(),rf.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(rf),r.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),r.multiply(rf)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class kM extends OM{constructor(){super(new Ag(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class BM extends Dg{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(dn.DEFAULT_UP),this.updateMatrix(),this.target=new dn,this.shadow=new kM}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class zM extends Dg{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:td}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=td);const VM=`uniform float uTime;\r
\r
